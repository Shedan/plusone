...
* Multiple accommodations booking by one guest.
* Shortcodes and widgets for setting up the system.
* Currency support.
...
* 3 booking confirmation modes: by admin manually, by customer via email, automatic confirmation upon a payment (online payments or after arrival).
...
* Automatic bookings synchronization with OTAs (exchange calendars via iCal). This will help you rent out accommodations on different platforms simultaneously and avoid overbooking.
...
Hotel Booking Lite plugin, Copyright (C) 2019, MotoPress https://motopress.com/
